...
class SettingsController extends Controller
{
    ...
    public function actionProfile()
    {
        ...
        if ($model->load(\Yii::$app->getRequest()->post()) && $model->save()) {
            \Yii::$app->getSession()->setFlash('success', \Yii::t('user', 'Your profile settings have been successfully saved'));
            return $this->refresh();
        }
    ...
    public function actionAccount()
    {
        ...
        if ($model->load(\Yii::$app->getRequest()->post()) && $model->save()) {
            \Yii::$app->session->setFlash('success', \Yii::t('user', 'Your Account settings have been successfully saved'));
            return $this->refresh();
        }
